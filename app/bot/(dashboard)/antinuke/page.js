...
export default featurePage({
  ...
  icon: "shield",
  title: "Antinuke",
  subtitle: "Limit what mods can destroy. Off until enabled — punishes staff, so whitelist trusted people.",
  description: "Watches the audit log: if a non-whitelisted member exceeds the threshold of destructive actions in the window, they're punished. The server owner and the bot are always exempt. Bot needs View Audit Log + the punishment permission (Manage Roles / Kick / Ban), and its role above the offenders'.",
  fields: FIELDS,
});
