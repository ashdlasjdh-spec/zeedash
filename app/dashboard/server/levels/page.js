...
const FIELDS = [
  ...
  { key: "message", label: "Level-up message", type: "textarea", rows: 2, placeholder: "🎉 {user.mention} reached level {level}!", hint: "Variables: {user.mention} · {user.name} · {level} · {server}" },
