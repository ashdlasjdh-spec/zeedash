...
export default async function Overview() {
  ...
  // Recent-activity feed is oversight data — management+ (242+) only.
  ...
  return (
    <>
      ...
      <p className="page-sub">You're signed in as <b style={{color:"var(--text)"}}>{user.role}</b>. Use the sidebar to reach the tools your rank can access.</p>
      {seesActivity && (
        <div className="card">
