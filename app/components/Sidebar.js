...
const ICON = {
  ...
  "Economy & Fun": ["M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18z", "M12 7v10", "M9.5 9.2a2.2 2.2 0 0 1 2.5-1.2c1.4.2 2 1 2 1.8 0 1.9-4 1.3-4 3.2 0 .9.7 1.6 2 1.8a2.2 2.2 0 0 0 2.5-1.2"],
};
function Icon({ label }) {
