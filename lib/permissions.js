...
export const LVL = {
  PERKS: 247,       // staff advisor+ : grant powers / stands / SVJ car / tools / gamepasses
...
const PERK_CATS = new Set(["power", "stand", "car", "tool", "gamepass"]);
...
export const GRANT_CATS = ["power", "stand", "car", "tool", "gamepass", "tag", "emoji"];
