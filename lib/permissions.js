...
export const LVL = {
  PERKS: 247,       // staff advisor+ : grant gamepasses / powers / shazam variants
  ...
  LEADERSHIP: 251,  // co owners+     : SVJ car / tools / stands / start-BR + dashboard whitelist + settings
...
// Staff advisor+ (247): gamepasses, powers, shazam variants.
const PERK_STAFFADV = new Set(["gamepass", "power", "shazam"]);
// Co owners+ (251): SVJ car, tools, stands, and BR-start perms.
const PERK_COOWNER = new Set(["car", "tool", "stand", "startbr"]);
