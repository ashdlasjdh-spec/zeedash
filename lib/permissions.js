...
export const PERMISSIONS = {
  ...
  admin:     { grant: ["tag", "emoji", "gamepass", "perk", "tool", "power", "stand", "car"], group: true,  config: false, whitelist: false },
  cofounder: { grant: ["tag", "emoji", "gamepass", "perk", "tool", "power", "stand", "car"], group: true,  config: true,  whitelist: true  },
  owner:     { grant: ["tag", "emoji", "gamepass", "perk", "tool", "power", "stand", "car"], group: true,  config: true,  whitelist: true  },
};
