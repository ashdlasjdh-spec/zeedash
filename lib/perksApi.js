...
// ---- read the shared DB (for the dashboard's "load everything" views) ----
export function listPerks() { return call("/perks", "GET"); } // { perks: [{ userId, gamepasses, powers, tools, armor, ... }] }
export function listTags()  { return call("/tags", "GET"); }
export function listEmojis() { return call("/emojis", "GET"); } // { emojis: { [userId]: "str" } }
export function setEmoji(userId, emojiStr, grantedBy) { return call(`/emojis/${userId}`, "POST", { emojiStr, grantedBy }); }  // { tags: { [groupId]: { name, colors, iconId, animated, rankTags } } }
