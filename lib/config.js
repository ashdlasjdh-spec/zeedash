...
export async function getConfig() {
  ...
  return {
    ...
    // Ban-log Discord webhook — dashboard override first, else the BAN_WEBHOOK_URL env var. Kept in the
    // DB (private) rather than committed, since these repos are public.
